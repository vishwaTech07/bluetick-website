...
export const accardiancontentfaq = [
    {
        title: `1. Why Choosing the "Best Digital Marketing Institute" Matters in ${new Date().getFullYear()}`,
        content: (
          <p>In a world saturated with information, searching for the best digital marketing course can be overwhelming. Whether you are looking for a digital marketing course near me or the top digital marketing institutes in India, the criteria have changed. It’s no longer just about learning social media or Google marketing, it’s about generating positive ROI. <br /><br />
          At Bluetick Academy, we don't just teach digital marketing; we teach the "Business of Digital Growth." Having spent crores of rupees on live campaigns, our trainers bring a level of EEAT (Experience, Expertise, Authoritativeness, and Trustworthiness) that is unmatched in the industry.
          </p>
        )
    ...
    {
        title: "2. Digital Marketing Course in Bangalore: What You Will Master",
        content: (
          <>
            <p>
              When students look for digital marketing course details, they want a breakdown of the syllabus that translates to real-world skills. Our curriculum is widely considered the best digital marketing course syllabus because it bridges the gap between basic concepts and advanced AI execution
              <br /><br />
              ...
              * Technical SEO: Site speed, Core Web Vitals, and Schema Markup.<br />
              ...
              <strong>Phase 2: Paid Media & Performance Marketing</strong><br />
              * Google Ads & PPC: Search, Display, Video, and Shopping ads.<br />
              * Meta Ads (Facebook/Instagram): Mastering the algorithm for lead generation.<br />
              * LinkedIn Ads: B2B marketing strategies that actually convert.
              <br /><br />
        
              <strong>Phase 3: The AI Revolution (The 50+ Tool Mastery)</strong><br />
              We are the first to offer a digital marketing course with AI tools integrated into every module. You won't just learn about AI; you will use it to automate 70% of a marketer's workload using Jasper, Copy.ai, Writesonic, Midjourney, DALL-E 3, Adobe Firefly, HeyGen, SurferSEO, SEMRush AI, Perplexity, Screaming Frog AI, Zapier, Make.com, Bardeen
              Madgicx, AdCreative.ai.
              <br /><br />
    ...
    {
        title: "3. Why Bluetick Academy Ranks Among the Top 10 Digital Marketing Institutes",
        content: (
          <>
            <p>
              If you look at the top 10 digital marketing institutes in India, most offer theoretical knowledge. Bluetick Academy is consistently rated as a top digital marketing institute because we prioritize 100% hands-on training.
              <br /><br />
        
              <strong>Our Unique Value Propositions (USPs):</strong><br />
               * Industry Expert Trainers: Mentors with 10+ years of experience who have managed multi-crore marketing budgets.<br /><br />
               * 10+ Live Projects: From e-commerce to B2B SaaS, you work on real businesses.<br /><br />
               * 100% Placement Assistance: Our career cell ensures you land a high-paying role.<br /><br />
               * Hybrid Learning: The flexibility of a digital marketing course online or an offline digital marketing course in Bangalore.
              <br /><br />
    ...
    {
        title: "4. Digital Marketing Training in Bangalore: The Bluetick Advantage",
        content: (
          <>
            <p>
              For those searching for a digital marketing course in Bangalore, our campus in Indiranagar is the heart of the tech ecosystem. Being in the "Silicon Valley of India" gives our students a distinct advantage in networking and high-ticket job opportunities.
              If you are looking for a digital marketing course near me and you are based in Bangalore, our offline batches provide a collaborative environment that online-only courses simply cannot replicate.
              <br /><br />
    ...
    {
        title: "5. Digital Marketing Course Fees & ROI",
        content: (
          <>
            <p>
              We understand that digital marketing course fees are a major factor in your decision. At Bluetick Academy, we offer a transparent fee structure with flexible EMI options.
              <br /><br />
        
              {/* <strong>1. Comprehensive and Up-to-Date Curriculum:</strong><br /> */}
              * Value for Money: Compared to other top digital marketing institutes, our ROI is the highest because you graduate with a portfolio of 10+ live projects and 100% placement assistance. 
              <br /><br />
        
              {/* <strong>2. Learning Flexibility and Multiple Formats:</strong><br /> */}
              * Scholarships: Based on merit and early-bird registrations.
              <br /><br />
        
              {/* <strong>3. Hands-On Practical Training:</strong><br /> */}
              * Inclusions: Fees cover all 50+ AI tools during the training, certification, and lifetime access to our alumni community.
              <br /><br />
    ...
    {
        title: "6. Which is the best digital marketing course in India with job placement?",
        content: (
          <>
            <p>
              Bluetick Academy offers the most comprehensive program featuring 100% job placement assistance. Our graduates are placed in top MNCs and high-growth startups because they master both traditional marketing and 50+ AI tools.
              <br /><br />
    ...
    {
        title: "7. How do I find the best digital marketing institute near me?",
        content: (
          <>
            <p>
              When searching for a "digital marketing institute near me," look for three things: trainer experience (look for 10+ years), practical project count (minimum 10), and placement history. Bluetick Academy provides both offline classes in Bangalore and live online classes globally.
              <br /><br />
    ...
    {
        title: "8. Is a digital marketing course with job placement guaranteed?",
        content: (
          <>
            <p>
              While no one can "guarantee" a job, Bluetick has a 100% placement record due to its detailed curriculum, job oriented training with 50+ AI tools. This includes resume building, mock interviews, and direct referrals to over 500+ hiring partners. Our focus is on making you so skilled that companies want to hire you.
              <br /><br />
    ...
    {
        title: "9. What are the digital marketing course details for beginners?",
        content: (
          <>
            <p>
              {/* <strong>
              ...
              A beginner-friendly course should cover the 360-degree spectrum of marketing: SEO, SEM, Social Media, Email Marketing, Content Strategy, and Analytics. Bluetick Academy’s program is designed to take you from zero to expert in 4.5 months.
              <br /><br />
        ...
        title: "10. Who are the top 10 digital marketing institutes in Bangalore?",
        content: (
          <>
            <p>
            A: Bangalore hosts several reputable institutes. However, Bluetick Academy is often ranked at the top due to its unique "AI-First" approach and trainers who have spent crores on actual marketing campaigns, ensuring the most practical learning experience. 
          <br /><br />
            </p>
          </>
        )
    ...
    {
        title: "11. Why should I choose an AI-based digital marketing course?",
        content: (
          <>
            <p>
            In 2026, AI is non-negotiable. An AI-based Digital Marketing course teaches you how to use tools like Midjourney for design and ChatGPT for strategy, making you 10x faster and more efficient than a traditional marketer. This is why we teach 50+ AI tools in our curriculum.
          <br /><br />
            </p>
          </>
        )
    ...
    {
        title: "12. What is the salary after completing the best digital marketing course?",
        content: (
          <>
            <p>
            Salaries for freshers range from ₹3.5 LPA to ₹6.5 LPA. For professionals with 2-3 years of experience who have mastered performance marketing and AI, salaries can easily exceed ₹12-15 LPA.
          <br /><br />
            </p>
          </>
        )
    ...
    {
        title: "13. Can I take a digital marketing course online while working?",
        content: (
          <>
            <p>
              Yes. We offer late-evening batches at 7.30pm-9.30pm and early morning batch at 7.30am to 9am for our online digital marketing course, allowing working professionals to upskill without quitting their jobs.   
             <br /><br />
            </p>
          </>
        )
    ...
    {
        title: "14. Step-by-Step Guide to Starting Your Career",
        content: (
          <>
            <p>
              To help students searching for how to start a career in digital marketing, here is our proven <br />
              <strong>
                5-step roadmap:
              </strong> <br />
               * Enroll in a Top Digital Marketing Institute: Ensure the curriculum covers AI and Advanced Performance Marketing. <br />
              * Master the 50+ AI Tools: Efficiency is your biggest competitive advantage in 2026.<br />
              * Build a Live Portfolio: Complete the 10+ practical projects included in our course.<br />
              * Get Certified: Obtain industry-recognized certifications from Google, Hubspot, SEM Rush and Bluetick Academy.<br />
              * Leverage Placement Assistance: Use our network to land your dream job.<br /><br />
       ...
       {
        title: "15. Final Thoughts: The Best Investment for Your Future",
        content: (
          <>
            <p>
              If you are searching for the best digital marketing course in India, your search ends here. Whether it's the digital marketing course fees, the job placement record, or the AI tool mastery, Bluetick Academy is designed to exceed your expectations.          <br /><br />
            </p>
          </>
        )
